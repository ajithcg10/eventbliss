    ...
    <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-5">
                ...
                render={({ field }) => (
                  ...
                  <FormControl>
                    <div className='flex items-center h-[54px] w-full overflow-hidden rounded-full bg-grey-50 px-4 py-2'>
                      <Image src="/assets/icons/calendar.svg" alt='calendar' width={24} height={24} className='grayscale'/>
        ...
        <div className='flex flex-col gap-5 md:flex-row'>
          <FormField
            ...
            <FormControl>
              <div className='flex items-center h-[54px] w-full overflow-hidden rounded-full bg-grey-50 px-4 py-2'>
                    <Image src="/assets/icons/dollar.svg" alt='dollar' width={24} height={24} className='grayscale'/>
